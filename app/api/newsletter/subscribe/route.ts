...
const NICHE = 'trt' as const
const DIRECTORY_SLUG = 'trt-clinics-directory' as const
const NEWSLETTER_NAME = 'Hormone Fieldnotes' as const
const CONFIRM_URL_BASE = 'https://findtrtclinic.com/newsletter/confirm'
