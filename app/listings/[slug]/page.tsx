    ...
    return (<>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className="flex items-center gap-1 text-sm text-brand-steel mb-6" aria-label="Breadcrumb">
          ...
          <ChevronRight className="w-4 h-4" aria-label=""/>
          <Link href={`/listings?city=${encodeURIComponent(listing.city)}&state=${listing.state}`} className="hover:text-brand-blue transition-colors">
      ...
      <div className="mt-8 rounded-xl bg-gray-50 border border-gray-200 p-5">
        ...
        {/* Related listings */}
        {related.filter(r => r.id !== listing.id).length > 0 && (<section className="mt-12">
